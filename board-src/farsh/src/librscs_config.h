...
//=========================================================
//Настройка датчика тока ina219
//=========================================================
#define RSCS_INA219_TIMEOUT_CYCLES (5)	// каждый цикл 100 микросекунд
...
#define RSCS_SDCARD_SPI_CLK_SLOW (400)
...
#define RSCS_UART_BUFSIZE_TX 250 // размер буфера на TX
